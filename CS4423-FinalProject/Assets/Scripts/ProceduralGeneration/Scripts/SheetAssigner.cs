...
public class SheetAssigner : MonoBehaviour {
	...
	[SerializeField]
	GameObject RoomObj;
	// GameObject environmentParent = new GameObject("EnvironmentParent");
	public Vector2 roomDimensions = new Vector2(16*17,16*9);
	// 272 144
	public Vector2 gutterSize = new Vector2(16*9,16*4);
	// 144 64
	// public Vector2 roomDimensions = new Vector2(16*10,16*6);
	// public Vector2 gutterSize = new Vector2(16*2,16*2);
	...
	public void Assign(Room[,] rooms){
		foreach (Room room in rooms){
			...
			// myRoom.transform.SetParent(environmentParent.transform, true);
